			...
			<div class = "row">
				...
				<div class = "col-md-4">
					...
					<div class = "row">
						...
						<div class="col-md-4">'.$row['title'].'</div>
					</div>
					<div class="row">
						<div class="col-md-2">First Name: </div>
						<div class="col-md-2">'.$row['f_name'].'</div>
					</div>
					<div class="row">
						<div class="col-md-4">Middle Name: </div>
						<div class="col-md-4">'.$row['mid_name'].'</div>
					</div>
					<div class="row">
						<div class="col-md-4">Last Name: </div>
						<div class="col-md-4">'.$row['l_name'].'</div>
					</div>
					<div class="row">
						<div class="col-md-4">Display Name: </div>
						<div class="col-md-4">'.$row['dp_name'].'</div>
					</div>
				</div>
				<div class = "col-md-4">
					<div class = "row">
					...
					<div class="row">
						...
						<div class="col-md-4">'.$row['cnslt_type'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Proposed Assignment:</div>
						<div class="col-md-4">'.$row['assgn'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Co-ordinator: </div>
						<div class="col-md-4">'.$row['coord_id'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Payment Status: </div>
						<div class="col-md-4">'.$row['pay_stat'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Consultant Status: </div>
						<div class="col-md-4">'.$row['cnslt_stat'].'</div>
					</div>
				</div>
			</div>
			...
			<div class = "row">
				...
				<div class = "col-md-5">
					...
					<div class = "row">
						...
						<div class="col-md-4">'.$row['add_line_1'].'</div>
					</div>
					<div class = "row">
						<div class="col-md-4">Address Line2: </div>
						<div class="col-md-4">'.$row['add_line_2'].'</div>
					</div>
					<div class = "row">
					...
					<div class = "row">
						...
						<div class="col-md-4">'.$row['pincode'].'</div>
					</div>
					<div class = "row">
						<div class="col-md-4">State:</div>
						<div class="col-md-4">'.$row['state'].'</div>
					</div>
					<div class = "row">
						<div class="col-md-4">Country: </div>
						<div class="col-md-4">'.$row['country'].'</div>
					</div>
				</div>
				<div class = "col-md-5">
					<div class = "row">
					...
					<div class = "row">
						...
						<div class="col-md-4">'.$row['mob_no'].'</div>
					</div>
					<div class = "row">
						<div class="col-md-6">Primary Email ID: </div>
						<div class="col-md-4">'.$row['email_1'].'</div>
					</div>
					<div class = "row">
						<div class="col-md-6">Sec. Email ID: </div>
						<div class="col-md-4">'.$row['email_2'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">PAN No: </div>
						<div class="col-md-4">'.$row['pan_no'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Aadhaar No: </div>
						<div class="col-md-4">'.$row['aadhaar_no'].'</div>
					</div>
					<div class = "row">
						<div class="col-md-6">Date of Birth: </div>
						<div class="col-md-4">'.$row['dob'].'</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-5">
					...
					<div class="row">
						...
						<div class="col-md-4">'.$row['degree'].'</div>
					</div>

					<div class="row">
						<div class="col-md-4">Discipline: </div>
						<div class="col-md-4">'.$row['discipline'].'</div>
					</div>
				</div>
				<div class="col-md-5">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-4">'.$row['ifsc_code'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Bank Branch Name: </div>
						<div class="col-md-4">'.$row['branch_name'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Bank Account No: </div>
						<div class="col-md-4">'.$row['acc_no'].'</div>
					</div>
					<div class="row">
						<div class="col-md-6">Bank Name: </div>
						<div class="col-md-4">'.$row['bank_name'].'</div>
					</div>
				</div>
			</div>
			<div class="row">
